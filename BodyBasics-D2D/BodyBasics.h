...
private:
    ...
    int DetectHand(HandState handState, const D2D1_POINT_2F& handPosition);

    int DetectDefaultGesture(HandState handStateR, HandState handStateL, const D2D1_POINT_2F& handPositionR, const D2D1_POINT_2F& handPositionL);
